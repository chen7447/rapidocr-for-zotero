...
const ZH: Table = {
  ...
  "settings.twoColumn": "双栏版面(先左栏后右栏,仅本次)",
...
const EN: Table = {
  ...
  "settings.twoColumn": "Two-column layout (left column then right, this run only)",
  ...
  "stageOverlay.menu": "OCR Stage Overlay",
